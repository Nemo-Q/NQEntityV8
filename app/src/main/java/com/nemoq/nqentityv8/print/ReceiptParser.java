...
/**
 * Created by Martin Backudd on 2015-08-21. Takes a Xml string or JSON and parses it to Epson-Printer commands.
 */
public class ReceiptParser {
    ...
    public byte[] testXml(InputStream inputStream) throws IOException, XmlPullParserException {
      ...
      return xmlToPrinterBytes(inputStream);
    ...
    private static byte[] makeRaster(Bitmap bitmap,boolean scaled,boolean flipped){
        ...
        return BitmapTranslator.getInstance().getPortableBitmap(bitmap, scaled, flipped);
